...
public enum VeluxItemType {
    BRIDGE_RELOAD(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_RELOAD,
            SwitchItem.class, false, false, true, false),
    SCENE_ACTION(VeluxBindingConstants.THING_TYPE_VELUX_SCENE, VeluxBindingConstants.CHANNEL_SCENE_ACTION,
            SwitchItem.class, false, false, true, false),
    SCENE_SILENTMODE(VeluxBindingConstants.THING_TYPE_VELUX_SCENE, VeluxBindingConstants.CHANNEL_SCENE_SILENTMODE,
            SwitchItem.class, false, true, false, false),
    BRIDGE_STATUS(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_STATUS,
            StringItem.class, true, true, true, true, 1),
    BRIDGE_TIMESTAMP(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_TIMESTAMP,
            NumberItem.class, true, true, true, true, 1),
    BRIDGE_DO_DETECTION(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_DO_DETECTION,
            SwitchItem.class, false, false, true, false),
    BRIDGE_FIRMWARE(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_FIRMWARE,
            StringItem.class, true, false, false, false),
    BRIDGE_IPADDRESS(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_IPADDRESS,
            StringItem.class, true, false, false, false),
    BRIDGE_SUBNETMASK(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_SUBNETMASK,
            StringItem.class, true, false, false, false),
    BRIDGE_DEFAULTGW(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_DEFAULTGW,
            StringItem.class, true, false, false, false),
    BRIDGE_DHCP(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_DHCP, SwitchItem.class,
            true, false, false, false),
    BRIDGE_WLANSSID(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_WLANSSID,
            StringItem.class, true, false, false, false),
    BRIDGE_WLANPASSWORD(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_WLANPASSWORD,
            StringItem.class, true, false, false, false),
    BRIDGE_PRODUCTS(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_PRODUCTS,
            StringItem.class, true, false, false, true, 15),
    BRIDGE_SCENES(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_SCENES,
            StringItem.class, true, false, false, true, 5760),
    BRIDGE_CHECK(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_CHECK, StringItem.class,
            true, false, false, true, 5760),
    BRIDGE_SHUTTER(VeluxBindingConstants.THING_TYPE_BRIDGE, VeluxBindingConstants.CHANNEL_BRIDGE_SHUTTER,
            RollershutterItem.class, false, true, false, false),
    ACTUATOR_SERIAL(VeluxBindingConstants.THING_TYPE_VELUX_ACTUATOR, VeluxBindingConstants.CHANNEL_ACTUATOR_SERIAL,
    ...
    VeluxItemType(ThingTypeUID thingIdentifier, String channelIdentifier, Class<? extends GenericItem> itemClass,
            boolean isReadable, boolean isWritable, boolean isExecutable, boolean isToBeRefreshed, int refreshDivider) {
    ...
    VeluxItemType(ThingTypeUID thingIdentifier, String channelIdentifier, Class<? extends GenericItem> itemClass,
            boolean isReadable, boolean isWritable, boolean isExecutable, boolean isToBeRefreshed) {
